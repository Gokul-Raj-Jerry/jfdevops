                     ...
                     <div className="row align-items-center">
                        <div className="col-xl-6 col-lg-5 col-md-4">
                           <div className="header__social">
                              <ul>
                                 ...
                                 <li><Link to="#"><i > <FaPinterestP /> </i></Link></li>
                              </ul>
                           </div>
                        </div>
                        <div className="col-xl-6 col-lg-7 col-md-8">
                           <div className="header__info f-right">
                              <ul>
                                 <li>
                                    <Link to="tel:(+468)-254-762-443">
                                       <i > <FaPhoneAlt /> </i>
                                       (+91) 77602 88526
                                    </Link>
                                 </li>
                                 <li>
                                    <Link to="mailto:joyfultomail@gmail.com">
                                       <i > <FaEnvelope /> </i>
                                    ...
                                    <ul>
                                       <li>
                                          ...
                                          <ul className="submenu">
                                             <li>
                                                <NavLink to="/home">DevOps</NavLink>
                                             </li>
                                             <li>
                                                <NavLink to="/homeTwo">Animation</NavLink>
                                             </li>
                                             <li>
                                                <NavLink to="/homeThree">App DevOps</NavLink>
                                             </li>
                                             <li><NavLink to="/headerStyleSeven">IT Consulting Services</NavLink></li>
                                          </ul>
                                       </li>
