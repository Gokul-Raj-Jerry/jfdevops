               ...
               <div className="row">
                  ...
                  <div className="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1">
                     <div className="section__title section__title-3 mb-85 text-center">
                        ...
                        <p className='text-danger'>Unlocking Value: Stay Tuned for Our Upcoming Pricing Updates!</p>
                     </div>
                  ...
                  <div className="tab-content" id="price-tab-content">
                     ...
                     <div className="tab-pane fade show active" id="yearly" role="tabpanel" aria-labelledby="yearly-tab">
                        <div className="row">
                           ...
                           <SinglePrice title="Enterprise" price="0" />
                           <SinglePrice title="Premium" price="0" active="active" />
                           <SinglePrice title="Professional" price="0" />
