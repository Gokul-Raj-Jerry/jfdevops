      ...
      <>
         <section className="slider__area slider__area-2">
            ...
            <Slider className='slider-active' {...settings}>
               ...
               <HomeTwoSingleSlide slider_class="col-xl-6" content_class="slider__content-4" attr_1={<span >Welcome To JFD.</span>} attr_2={<h1 >Get more Impact Fasted</h1>} attr_3="By implementing these strategies, you can create animations that have a faster and more impactful effect, whether you're designing for web, video, presentations, or any other medium." btn_text="See what's New" />
